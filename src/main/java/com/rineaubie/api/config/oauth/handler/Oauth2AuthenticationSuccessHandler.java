...
import com.rineaubie.api.config.oauth.info.Oauth2UserInfo;
import com.rineaubie.api.config.oauth.info.Oauth2UserInfoFactory;
import com.rineaubie.api.config.oauth.repository.Oauth2AuthorizationBasedOnCookieRepository;
import com.rineaubie.api.config.oauth.token.AuthToken;
import com.rineaubie.api.config.oauth.token.AuthTokenProvider;
...
public class Oauth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    private boolean isAuthorizedRedirectUri(String redirectUri) {
        ...
        return appProperties.getOauth2().getAuthorizedRedirectUrils()
                .stream()
